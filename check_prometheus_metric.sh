...
then
  ...
  then
    ...
    NAGIOS_SHORT_TEXT="${METRIC_NAME} is ${PROMETHEUS_RESULT}|${METRIC_NAME}=${PROMETHEUS_RESULT}"
  ...
  then
    ...
    NAGIOS_LONG_TEXT="${METRIC_NAME} is ${PROMETHEUS_RESULT}|${METRIC_NAME}=${PROMETHEUS_RESULT}"
  fi
fi
if [[ "${NAGIOS_INFO}" = "true" ]]
then
    NAGIOS_SHORT_TEXT="${METRIC_NAME} is ${PROMETHEUS_RESULT}:${PROMETHEUS_METRIC}|${METRIC_NAME}=${PROMETHEUS_RESULT}"
fi
